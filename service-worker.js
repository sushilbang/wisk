...
const NETWORK_TIMEOUT = 3000; // 3 seconds - if network is slower, use cache
    ...
    event.respondWith(
        (async () => {
            ...
            try {
                ...
                // This prevents slow connections from hanging indefinitely
...
// Helper function to fetch with timeout - returns early if network is slow
const fetchWithTimeout = (request, timeout) => {
    return new Promise((resolve, reject) => {
        const timeoutId = setTimeout(() => reject(new Error('Network timeout')), timeout);
